...
Ext.define('ZJ02.view.JobBookList', {
  ...
  config: {
    ...
    items: [
      ...
      },
      {
        ...
        itemTpl: [
          ...
          '  </div>',
          '  <div class="b">',
          '    <div class="count">今日：<span>{todayPositionCount}</span></div>',
          '    <div class="count">累计：<span>{positionCount}</span></div>',
          '  </div>',
          '</div>'
        ]
      }
    ...
    listeners: [
      ...
      },
      {
        ...
        event: 'itemtap',
        delegate: '#list-msg-job-subscribe'
      }
    ]
  },
  ...
  onMydataview2ItemTap1: function(dataview, index, target, record, e, eOpts) {
    ...
    change_page('JobBookApplyList',dataview,item_data);
  ...
  build_list: function(data) {
    var x$list = x$('list-msg-job-subscribe');
