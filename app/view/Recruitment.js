...
Ext.define('ZJ02.view.Recruitment', {
  ...
  config: {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            xtype: 'button',
            id: 'recrut_btn_industry',
            itemId: 'mybutton1',
            text: '选择行业'
          },
          {
            xtype: 'button',
            id: 'recrut_btn_school',
            itemId: 'mybutton2',
            text: '选择学校'
          },
          {
        ...
        items: [
          {
            ...
            items: [
              {
                xtype: 'list',
                id: 'recrut_filter_list_industry_lv1',
                itemId: 'recrut_filter_list_industry_lv1',
                itemTpl: [
                  '<div>{industryName}',
                  '  <tpl if="has_child &gt; 0">',
          ...
          },
          {
            ...
            items: [
              {
                xtype: 'list',
                id: 'recrut_filter_list_industry_lv2',
                itemId: 'recrut_filter_list_industry_lv2',
                itemTpl: [
    ...
    listeners: [
      ...
      },
      {
        fn: 'onMybutton1Tap',
        event: 'tap',
        delegate: '#recrut_btn_industry'
      },
      {
        fn: 'onMybutton2Tap',
        event: 'tap',
        delegate: '#recrut_btn_school'
      },
      {
        fn: 'onMybutton3Tap',
        event: 'tap',
        delegate: '#recrut_btn_time'
      },
      {
        fn: 'onMydataview2ItemTap11',
        event: 'itemtap',
        delegate: '#list_recrut'
      },
      {
        fn: 'onCampustalk_filter_list_industry_lv1ItemTap',
        event: 'itemtap',
        delegate: '#recrut_filter_list_industry_lv1'
      },
      {
        fn: 'onCampustalk_filter_list_industry_lv2ItemTap',
        event: 'itemtap',
        delegate: '#recrut_filter_list_industry_lv2'
      },
      {
        fn: 'onCampustalk_filter_list_schoolItemTap',
        event: 'itemtap',
        delegate: '#recrut_filter_list_school'
      },
      {
        fn: 'onDp_pickerShow1',
        event: 'show',
  ...
  onMybutton1Tap: function(button, e, eOpts) {
    var x$flyout = x$('recrut_fo_industry');
  ...
  onMybutton2Tap: function(button, e, eOpts) {
    var x$flyout = x$('recrut_fo_school');
  ...
  onMybutton3Tap: function(button, e, eOpts) {
    ...
    var x$time_fe = x$('recrut_dp_time');
  ...
  onCampustalk_filter_list_industry_lv1ItemTap: function(dataview, index, target, record, e, eOpts) {
    var x$list_lv2 = x$('recrut_filter_list_industry_lv2');
  ...
  onDp_pickerShow1: function(component, eOpts) {
  ...
  onMybutton15Tap1: function(button, e, eOpts) {
    var _this = this;
  ...
  update: function(_p) {
    ...
    var x$industry = x$('recurt_fo_industry');
    var x$school = x$('recurt_fo_school');
    var x$time = x$('recurt_dp_time');
    ...
    var cur_industry_val = get_data( 'recrut_fo_industry','value' );
    if(cur_industry_val){
      params.industryId = cur_industry_val;
    }

    var cur_school_val = get_data( 'recrut_fo_school','value' );
    if(cur_school_val){
      params.schoolId = cur_school_val;
    }

    var cur_time_val = get_data( 'recrut_dp_time','value' );
    if(cur_time_val){
  ...
  init_fo_industry: function() {
    ...
    var x$list_lv1 = x$('recrut_filter_list_industry_lv1');
    var x$list_lv2 = x$('recrut_filter_list_industry_lv2');
  ...
  init_fo_school: function() {
    var x$flyout = x$('recrut_fo_school');
    var x$list = x$('recrut_filter_list_school');
  ...
  set_industry: function(value, text) {
    var fo_id = 'recrut_fo_industry';
    var btn_id = 'recrut_btn_industry';
  ...
  set_school: function(value, text) {
    var fo_id = 'recrut_fo_school';
    var btn_id = 'recrut_btn_school';
  ...
  set_time: function(value, text) {
    var fo_id = 'recrut_dp_time';
    var btn_id = 'recrut_btn_time';
  ...
  reset_fo: function() {
    ...
    var x$industry = x$('recrut_fo_industry');
    var x$school = x$('recrut_fo_school');
    var x$time_fe = x$('recrut_dp_time');
    var x$time = i$('dp_picker',_this);


    var x$btn_industry = x$('recrut_btn_industry');
    var x$btn_school = x$('recrut_btn_school');
    var x$btn_time = x$('recrut_btn_time');
