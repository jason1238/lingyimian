/*
 * File: app/view/HomeSearchResult.js
 *
...
Ext.define('ZJ02.view.HomeSearchResult', {
  ...
  config: {
    ...
    items: [
      ...
      },
      {
        ...
        itemTpl: [
          ...
          '    <p>{companyName}</p>',
          '  </div>',
          '  <div class="i js_arrow_btn">',
          '  	<span></span>',
          '  </div>',
          '  <div class="b">',
          '    <div class="count"><span>发布时间</span></div>',
    ...
    listeners: [
      ...
      },
      {
        ...
        event: 'itemtap',
        delegate: '#list-home-search-result'
      },
      {
        fn: 'onMybutton72Tap',
        event: 'tap',
  ...
  onMydataview2ItemTap1: function(dataview, index, target, record, e, eOpts) {
    ...
    if(event_on(e,'.js_arrow_btn')){
      console.log('detail');

      change_page('InternPositionDetail',dataview,item_data);
    ...
    //var page = Ext.create('ZJ02.view.RecruitmentDetail', {fullscreen: true});
